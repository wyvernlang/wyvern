...
public class EmitLLVMNative {
	...
	public static native String methodCallToLLVMIR (OIRMethodCall let, String objName, String[] argNames, String returnTypeName, String[] argTypeNames, String objTypeName);
