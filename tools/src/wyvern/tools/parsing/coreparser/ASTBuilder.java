...
public interface ASTBuilder<AST,Type> {
	...
	public AST defDecl(String name, Type type, String genTypeName, List args, AST body, boolean isClassDef, FileLocation loc);
	...
	public AST application(AST function, AST arguments, FileLocation loc, String genericType);
