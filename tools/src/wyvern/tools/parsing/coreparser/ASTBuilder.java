...
//	public AST effectDecl(String name, AST exp, FileLocation loc);
	public AST effectDecl(String name, FileLocation loc, String effects);
	...
	public AST effectDeclType(String name, FileLocation loc, String effects);
