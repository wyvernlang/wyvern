...
public class EffectDeclaration extends Declaration implements CoreAST {
	...
	public EffectDeclaration(String name, TypedAST definition, FileLocation location) {
	...
	public TypedAST cloneWithChildren(Map<String, TypedAST> nc) {
		if (nc.containsKey("definition"))
			return new EffectDeclaration(getName(), binding.getType(), nc.get("definition"), location);
		return new EffectDeclaration(getName(), binding.getType(), null, location);
	}
	...
	public DeclType genILType(GenContext ctx) {
		...
		return new EffectDeclType(getName(), vt);
	}
	...
	public wyvern.target.corewyvernIL.decl.Declaration generateDecl(GenContext ctx, GenContext thisContext) {
		...
		return new wyvern.target.corewyvernIL.decl.EffectDeclaration(getName(), expectedType, definition.generateIL(ctx, expectedType, null), location);
	}
	...
	public void addModuleDecl(TopLevelContext tlc) {
		wyvern.target.corewyvernIL.decl.Declaration decl =
			new wyvern.target.corewyvernIL.decl.EffectDeclaration(getName(),
